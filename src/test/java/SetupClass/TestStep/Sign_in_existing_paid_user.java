...
public void user_navigate_to_complete_deck_from_account_dashboard_page() throws InterruptedException  {
	 ...
	 driver.get("https://www1.slideteam.net/complete-powerpoint-decks-presentations/all-powerpoint-complete-decks.html");
	 Thread.sleep(3000);
...
public void user_Logout_from_Website_efu() throws Throwable {
